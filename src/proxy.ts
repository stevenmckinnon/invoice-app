...
export const config = {
  matcher: [
     ...
     * - manifest.webmanifest (PWA manifest, generated by app/manifest.ts)
     * - public folder files
     */
    "/((?!api|_next/static|_next/image|favicon.ico|manifest.webmanifest|.*\\.(?:svg|png|jpg|JPG|jpeg|gif|webp)$).*)",
  ],
};
